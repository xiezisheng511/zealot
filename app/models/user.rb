...
PROVIDERS = %i[feishu gitlab google_oauth2 ldap openid_connect github gitea sso].freeze
...
class User < ApplicationRecord
  ...
  devise :database_authenticatable, :registerable, :confirmable, :rememberable, :trackable, 
         ...
         :omniauthable, omniauth_providers: %i[feishu gitlab google_oauth2 ldap openid_connect github gitea sso].freeze
